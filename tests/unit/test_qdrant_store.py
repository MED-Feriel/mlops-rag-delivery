...
def test_init_creates_collection_when_missing():
    ...
    # 8 index payload attendus : source, source_service, topic, zone, criticite,
    # type_event, categorie, vehicule_type
    assert mock_client.create_payload_index.call_count == 8
